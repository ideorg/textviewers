...
TEST (Util, maxLineLen) {
    ...
    //maxLineLen = 40
    deque<LBInfo> Aest = {{0, 40, 0}, {40, 20, 1}, {61, 19, 0}, {80, 1, 1}, {82, 38, 0}, {120, 32, 0}};
    deque<LBInfo> Best = {{0, 40, 0}, {40, 40, 0}, {80, 10, 1}, {91, 29, 0}, {120, 40, 0}, {160, 40, 0}, {200, 1, 1},
            {202, 38, 0}, {240, 12, 0}};
    deque<LBInfo> Cest = {{0, 10, 1}, {11, 29, 0}, {40, 40, 0}, {80, 40, 0}, {120, 1, 1},
            {122, 38, 0}, {160, 12, 0}};
